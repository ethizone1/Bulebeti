...
const AdminNavbar = ({ currentTier = "Platinum" }) => {
    ...
    const fetchPendingNotifications = async () => {
      try {
        ...
        const settings = JSON.parse(
          localStorage.getItem("bulebeti_notif_settings"),
        ) || { res: true, cat: true, fb: true, mkt: false };
  ...
  return (
    ...
    >
            ...
            onKeyDown={(e) => {
              if (e.key === "Enter") {
                window.dispatchEvent(
                  new CustomEvent("open-ai-chat", { detail: searchQuery }),
                );
      ...
      >
        {/* Platform logo removed from admin navbar; customer header shows it left-side */}
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            <span>⚡</span> <span className="hide-on-mobile">Actions</span>{" "}
