...
const SupportForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage('Your inquiry has been submitted! A member of the BuleBet team will contact you shortly.');
  ...
  return (
    <div className="support-form py-3" style={{ maxWidth: '800px', margin: '0 auto' }}>
      <div className="mb-4">
        <h1 className="fs-3 fw-bold m-0">Platform Support</h1>
        <p className="text-muted mb-0">Need help with your account or the platform? Contact the BuleBet Super Admin team.</p>
      </div>
