...
const AddLocation = ({ currentTier }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!token) throw new Error('You must be logged in to register a sister restaurant.');
  ...
  return (
    <div className="add-location py-3">
      <div className="mb-4">
        ...
        <h1 className="fs-3 fw-bold m-0">{t('admin_loc_add') || 'Add Sister Restaurant'}</h1>
      </div>

      <div className="card border-0 shadow-sm rounded-4" style={{ maxWidth: '700px' }}>
        <div className="card-body p-4 p-md-5">
          ...
          <form onSubmit={handleSubmit} className="row g-4">
            <div className="col-12 col-md-6">
              <label className="form-label fw-bold small mb-1">RESTAURANT NAME</label>
              <input 
                type="text" 
                value={name} 
            ...
            <div className="col-12 col-md-6">
              <label className="form-label fw-bold small mb-1">WEBSITE SLUG (URL PART)</label>
              <input 
                type="text" 
                value={slug} 
            ...
            <div className="col-12">
              <label className="form-label fw-bold small mb-1">CUISINE TYPE</label>
              <select 
                value={cuisineType} 
            ...
            {tier === 'Premium' && (
              <div className="col-12">
                <label className="form-label fw-bold small mb-1">MENU LAYOUT STYLE</label>
                <select 
                  value={menuLayout} 
            ...
            <div className="col-12">
              <label className="form-label fw-bold small mb-1">FULL ADDRESS</label>
              <input 
                type="text" 
                value={address} 
            ...
            <div className="col-12">
              <label className="form-label fw-bold small mb-1">RESTAURANT LOGO IMAGE</label>
              <div className="border border-dashed p-4 text-center rounded position-relative bg-light">
                {logoBase64 ? (
                  <div>
                    <img src={logoBase64} alt="Logo Preview" className="rounded mb-2" style={{ maxHeight: '80px' }} />
                    <button 
                      type="button" 
