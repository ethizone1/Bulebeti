...
const MenuManagement = ({ currentTier = "Platinum" }) => {
  ...
  const deleteItem = async (id, name) => {
    if (
      !window.confirm(
        `Remove "${name}" from your menu?\n\nThis only removes it from your restaurant. The item will NOT be deleted from the universal menu.`,
      )
    )
      return;
    ...
    <div className="menu-management">
      ...
      {globalMenuOpen && (
        ...
        >
          ...
          >
            ...
            >
              Browse dishes submitted by other restaurants across the platform.
              Click 'Add to My Menu' to instantly copy an item into your
              restaurant!
            </p>

            {loadingGlobal ? (
              <div style={{ textAlign: "center", padding: "40px" }}>
                Loading universal items...
              </div>
            ) : (
              <div
                style={{
      ...
      >
        <h1 style={{ fontSize: "24px", margin: 0 }}>
          {t("admin_menu_mgt_title")}
        </h1>
        <div style={{ display: "flex", gap: "12px" }}>
          <button
            onClick={fetchGlobalMenu}
          ...
          {["All", "Starters", "Mains", "Desserts", "Beverages"].map((cat) => (
            <button
              ...
              style={{
                ...
                backgroundColor:
                  filter === cat ? "var(--primary)" : "transparent",
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: "1px solid var(--platinum)",
                        cursor: "pointer",
                        backgroundColor: item.visible ? "#e6f4ea" : "#f3f4f6",
                        color: item.visible ? "#1e7e34" : "#6b7280",
                        minWidth: "70px",
                      }}
                    >
                      {item.visible
