...
const MenuDescription = ({ text }) => {
  ...
  return (
    <p
      style={{ color: "var(--on-surface-variant)", fontSize: "14px", flex: 1 }}
    >
...
const RestaurantLandingPage = () => {
  ...
  const scrollCarousel = (direction) => {
    if (carouselRef.current) {
      const scrollAmount =
        window.innerWidth > 768 ? 1100 : window.innerWidth * 0.95;
                ...
                >
                  ...
                  >
                    <div style={{ marginBottom: "40px" }}>
                      ...
                      >
                        {event.restaurantNameField || restaurant.name}
                      </div>
                      <div
                        style={{
                          fontSize: "16px",
                    ...
                    <div style={{ marginBottom: "40px" }}>
                      ...
                      >
                        {event.isFree
                          ? "FREE ENTRY"
                          : `${event.price} ${event.currency || "ETB"}`}
                      </div>
                    </div>
              ...
              {categories.map((cat) => (
                <button
                  ...
                  style={{
                    ...
                    backgroundColor:
                      menuFilter === cat ? "var(--primary)" : "transparent",
