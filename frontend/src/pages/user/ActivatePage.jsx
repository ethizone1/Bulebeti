  ...
  if (success) {
    return (
      <div className="container min-vh-100 d-flex flex-column justify-content-center align-items-center">
        <div className="card border-0 shadow-sm rounded-4 p-5 text-center" style={{ maxWidth: '400px' }}>
          <div className="text-success mb-3" style={{ fontSize: '48px' }}>✓</div>
          <h2 className="fw-bold fs-4">Password Changed!</h2>
          <p className="text-muted small">You will be redirected to the login page momentarily.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container min-vh-100 d-flex flex-column justify-content-center align-items-center py-5">
      ...
      <div className="mb-4 text-center">
        <h1 className="fw-bold" style={{ fontSize: '28px', letterSpacing: '0.05em' }}>BULEBET</h1>
        <div className="text-muted small fw-bold">CHANGE PASSWORD</div>
      </div>

      <div className="card border-0 shadow-sm rounded-4" style={{ width: '100%', maxWidth: '400px' }}>
        <div className="card-body p-4 p-md-5">
          <h2 className="fs-5 fw-bold mb-4 text-center">Set Your New Password</h2>
          ...
          <div className="text-center mt-3">
            <Link to="/bulebet/login" className="text-decoration-none small">
              Back to Login
            </Link>
          </div>
        </div>
