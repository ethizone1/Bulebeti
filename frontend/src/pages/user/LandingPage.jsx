...
const LandingPage = () => {
  ...
  return (
    <div className="landing-page">
      ...
      {/* Pricing Section */}
      <section id="pricing" style={{ padding: 'var(--spacing-xxl) 0', backgroundColor: 'var(--surface)' }}>
        <div className="container">
      ...
      <section id="restaurants" style={{ 
        padding: 'var(--spacing-xxl) 0', 
        background: 'linear-gradient(180deg, var(--background) 0%, var(--surface-bright) 100%)',
        ...
        <div className="container">
          ...
          {loading ? (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '60px 0', gap: '16px' }}>
              ...
              <span style={{ fontSize: '14px', color: 'var(--on-surface-variant)', fontWeight: '600' }}>
            ...
            <div className="grid-auto" style={{
              ...
              {restaurants.map((restaurant) => {
                ...
                const charCodeSum = restaurant.name.split('').reduce((sum, char) => sum + char.charCodeAt(0), 0);
                const bannerGradient = gradients[charCodeSum % gradients.length];
                
                // Parse cuisine if it is embedded in description
                let cuisineBadge = '';
                if (restaurant.description) {
                  const match = restaurant.description.match(/A (.+?) restaurant\./i);
                  if (match) {
                    cuisineBadge = match[1].replace('-', ' ').replace(/\b\w/g, l => l.toUpperCase());
                  }
                }
                ...
                const getTierStyles = (t) => {
                  switch(t) {
                    case 'Premium':
                      return { bg: '#1e1b4b', color: '#fbbf24', border: '1px solid #fbbf24' };
                    case 'Platinum':
                      return { bg: '#f1f5f9', color: '#475569', border: '1px solid #cbd5e1' };
                    case 'Gold':
                      return { bg: 'rgba(212, 175, 55, 0.1)', color: '#b28900', border: '1px solid rgba(212, 175, 55, 0.3)' };
                    case 'Silver':
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{
                      height: '140px',
                      width: '100%',
                      background: restaurant.bannerUrl ? `url(${restaurant.bannerUrl}) center/cover no-repeat` : bannerGradient,
                      position: 'relative'
                    }}>
                      {/* Tier Badge Overlay */}
                      <div style={{
                    ...
                    <div style={{
                      ...
                      {restaurant.logoUrl ? (
                        ...
                        <div style={{
                          ...
                          height: '80px',
                          borderRadius: '50%',
                          background: 'linear-gradient(135deg, var(--gold) 0%, #b28900 100%)',
                          border: '4px solid white',
                          boxShadow: '0 4px 12px rgba(0, 0, 0, 0.1)',
                          display: 'flex',
                          alignItems: 'center',
