  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#f0f2f5', position: 'relative' }}>
      ...
      <div style={{ 
        ...
        <div style={{ marginLeft: '16px', color: 'var(--gold)', fontWeight: '700', fontSize: '14px', letterSpacing: '0.1em' }}>SUPER HUB</div>
      </div>
      ...
      <aside style={{
        ...
        <div style={{ marginBottom: '40px', textAlign: 'center', position: 'relative' }}>
          <h2 style={{ color: 'var(--gold)', letterSpacing: '0.1em', margin: 0 }}>SUPER HUB</h2>
          <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.5)', marginTop: '4px' }}>PLATFORM ADMINISTRATION</div>
          <button 
            onClick={() => setIsSidebarOpen(false)}
            style={{ position: 'absolute', top: '-10px', right: '-10px', background: 'none', border: 'none', color: 'white', fontSize: '20px', cursor: 'pointer' }}
        ...
        <div style={{ marginTop: 'auto', padding: '16px', borderTop: '1px solid rgba(255,255,255,0.1)', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          {/* Language Toggle */}
          <button 
          ...
          >
            <span style={{ color: language === 'en' ? 'var(--gold)' : 'rgba(255,255,255,0.5)' }}>EN</span> 
