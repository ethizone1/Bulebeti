  ...
  try {
    ...
    if (existingEvents > 0) {
      ...
      const dummyEvent = new Event({
        ...
        category: 'Live Music',
        description: 'Join us for our grand opening featuring live music, free drinks, and amazing food!',
        restaurantId: restaurant._id,
        restaurantNameField: restaurant.name,
        startDate: new Date().toISOString().split('T')[0],
        startTime: '19:00',
        eventImage: 'https://images.unsplash.com/photo-1540039155733-d7696f8b9148?w=800&q=80',
        isFree: true,
        status: 'Active'
      });
      await dummyEvent.save();
      console.log('Event collection created and dummy event inserted successfully!');
    }
