  ...
  try {
    ...
    const items = [
      ...
      },
      {
        ...
        price: 24,
        description:
          "Thinly sliced wagyu and parmigiano.\nIngredients: Wagyu Beef, Capers, Parmigiano\nContains: Dairy",
        category: "Starters",
        imageUrl:
          "https://images.unsplash.com/photo-1514333919153-ca54640ca227?w=400&q=80",
        isAvailable: true,
        restaurantId: restaurant._id,
      },
      {
      ...
      },
      {
        ...
        price: 120,
        description:
          "Aged for 12 years in French oak barrels.\nIngredients: Grapes, Oak Notes\nContains: Alcohol (13.5%)",
        category: "Beverages",
        imageUrl:
      ...
      {
        name: "Handcrafted Espresso Martini",
        price: 18,
        description:
          "Premium vodka with freshly brewed espresso.\nIngredients: Vodka, Espresso, Coffee Liqueur\nContains: Caffeine, Alcohol",
        category: "Beverages",
        imageUrl:
          "https://images.unsplash.com/photo-1545438102-799c3991ffb2?w=400&q=80",
        isAvailable: true,
        restaurantId: restaurant._id,
      },
      {
        ...
        price: 9,
        description:
          "Naturally carbonated with a touch of lime.\nIngredients: Spring Water, Lime Zest\nContains: Non-Alcoholic",
        category: "Beverages",
        imageUrl:
          "https://images.unsplash.com/photo-1548919973-5cdf592edc45?w=400&q=80",
        isAvailable: true,
        restaurantId: restaurant._id,
      },
    ];
    ...
    await Event.insertMany([
      {
        ...
        description:
          "Join us for a celebration of the season’s finest black truffles. Enjoy an exclusive 5-course tasting menu curated by our executive chef.",
        ...
        eventImage:
          "https://images.unsplash.com/photo-1541529086526-db283c563270?w=600&q=80",
        posterImage: "",
        bannerImage: "",
        isFree: false,
        price: "1500",
        ...
        reservationLink:
          "http://localhost:5173/bulebeti/the-golden-truffle/reservations",
        status: "Active",
      },
      {
        restaurantId: restaurant._id,
        ...
        category: "Happy Hour",
        description:
          "Experience rare vintages from the finest houses in Champagne. Includes caviar pairings.",
        restaurantNameField: "The Golden Truffle",
        branchLocation: "Main Downtown",
      ...
      },
      {
        ...
        description:
          "An intimate dining experience right in the heart of our kitchen. Watch the culinary magic happen up close.",
        restaurantNameField: "The Golden Truffle",
        branchLocation: "Main Downtown",
        ...
        indoorOutdoor: "Indoor",
        eventImage:
          "https://images.unsplash.com/photo-1514333919153-ca54640ca227?w=600&q=80",
        isFree: false,
        price: "2500",
        currency: "ETB",
        bookingRequired: true,
    ...
    await Location.insertMany([
      ...
      {
        restaurantId: restaurant._id,
        name: "bulebeti Waterfront",
        address: "456 Bay Ave, New York, NY",
        capacity: 120,
        status: "Open",
      },
      {
        restaurantId: restaurant._id,
        name: "bulebeti Uptown (New)",
        address: "789 High St, New York, NY",
        capacity: 60,
        status: "Coming Soon",
      },
    ]);
